...
import { ArrowPathIcon, ChartPieIcon, ChevronDownIcon, CursorArrowRaysIcon, FingerPrintIcon, PhoneIcon, PlayCircleIcon, SquaresPlusIcon } from '@heroicons/react/20/solid'
import {
  Bars3Icon,
  XMarkIcon,
      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
          ...
          <p className="mt-10 text-center text-xs leading-5 text-gray-500">
            &copy; 2023 P6M7G8 Inc. All rights reserved.
          </p>
        </div>
      </footer>
    </main>
